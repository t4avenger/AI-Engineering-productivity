...
| `pr_link` | PR | Pull-request URL when a reviewed fixture proves one. | URL | Always unavailable in the local edition until a fixture-backed URL exists; do not invent from `pull_request.count` or similar counters. |
