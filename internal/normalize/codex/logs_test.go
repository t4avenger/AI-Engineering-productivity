...
func TestNormalizeLogsMapsCodexSandboxOutcomeSignal(t *testing.T) {
	...
	assertNoStringCanaries(t, string(encoded), []string{"tiq-canary-sandbox-argument", "tiq-canary-sandbox-output", "sandbox-user@example.test", "tiq-canary-sandbox-body"})
}
